-- Complete MySQL setup for MMA Gym Bot
-- Run as root: mysql -u root -p < sql/setup.sql

-- Create database
CREATE DATABASE IF NOT EXISTS mmagym CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Create user and grant permissions
CREATE USER IF NOT EXISTS 'mmagym_user'@'localhost' IDENTIFIED BY 'mma';
GRANT ALL PRIVILEGES ON mmagym.* TO 'mmagym_user'@'localhost';
FLUSH PRIVILEGES;
